...
# Obtener la primera instancia EC2 cuyo tag Name sea 'webserver-rrhh'
instances = ec2.describe_instances(Filters=[{'Name': 'tag:Name', 'Values': ['webserver-rrhh']}])
...
for reservation in instances['Reservations']:
    ...
    if instance_id:
        break
if not instance_id:
    raise Exception("No se encontró ninguna instancia con el tag 'webserver-rrhh'.")
